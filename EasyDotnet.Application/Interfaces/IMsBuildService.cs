...
public interface IMsBuildService
{
  ...
  Task<(DotnetProject[] LoadedProjects, string[] UnloadedProjects)> LoadProjects(string[] projectPaths, TimeSpan maxWait, string? targetFrameworkMoniker = null, string configuration = "Debug", CancellationToken cancellationToken = default);
