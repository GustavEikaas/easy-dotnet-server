...
/// <summary>
/// NUnit v3 (VSTest adapter) discovery tests against a host-built, real NUnit assembly.
/// </summary>
  ...
  where TContainer : ServerContainer, new()
{
  ...
  public async Task Discover_MultipleNamespacesInOneFile_EachAppearsAsItsOwnLeafNamespace()
  {
    using var fixture = new TestProjectFixtureBuilder()
      .WithName("Sample.NUnitV3MultiNs")
  ...
  {
    using var fixture = new TestProjectFixtureBuilder()
      .WithName("Sample.NUnitV3ComplexArgs")
      .WithFramework(TestFrameworkKind.NUnitV3VsTest)
  ...
  {
    using var fixture = new TestProjectFixtureBuilder()
      .WithName("Sample.NUnitV3TestCaseSource")
      .WithFramework(TestFrameworkKind.NUnitV3VsTest)
  ...
  {
    using var fixture = new TestProjectFixtureBuilder()
      .WithName("Sample.NUnitV3Slow")
      .WithFramework(TestFrameworkKind.NUnitV3VsTest)
      .WithFile("SlowTests.cs", TestFixtures.NUnitSlowTests)
      .Build();
